...
df = pd.read_csv('citation-export.csv')

# Lista de palabras clave
palabras_clave = ['nurse', 'nursing' ]
...
df_filtrado.to_csv('referencias_nurse.csv', index=False)
...
df2 = pd.read_csv('referencias_nurse.csv')
